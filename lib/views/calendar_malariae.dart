...
class CalendarMalariae extends StatefulWidget{
  @override
  State<CalendarMalariae> createState() => _CalendarState();
}

class _CalendarState extends State<CalendarMalariae> {
