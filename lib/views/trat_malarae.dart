...
class Malarae extends StatefulWidget {
  @override
  State<Malarae> createState() => _MalaraeState();
}

class _MalaraeState extends State<Malarae> {
  @override
  void initState(){
    super.initState();
      ...
      home: Scaffold(
        ...
        floatingActionButton: Visibility(
          ...
          onPressed: () async{
            ...
            Navigator.of(context).pushNamed(AppRoutes.CALENDAR_MALARIAE, arguments: {"tipo": rcvdData['tipo'].toString(), "tratamento": rcvdData['tratamento'].toString()});
