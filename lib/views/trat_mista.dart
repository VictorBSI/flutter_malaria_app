...
class Mista extends StatefulWidget {
  @override
  State<Mista> createState() => _MistaState();
}

class _MistaState extends State<Mista> {
  @override
  void initState(){
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: rcvdData['tratamento'] == 'Opção 1'? const Text('mista - Opção 1'): const Text('mista - Opção 2'), backgroundColor: Colors.cyan,),
        body: SafeArea(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async{
            ...
            Navigator.of(context).pushNamed(AppRoutes.CALENDAR_MISTA, arguments: {"tipo": rcvdData['tipo'].toString(), "tratamento": rcvdData['tratamento'].toString()});
