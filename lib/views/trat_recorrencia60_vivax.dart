...
class VivaxOvaleRecorrencia extends StatefulWidget {
  @override
  State<VivaxOvaleRecorrencia> createState() => _VivaxOvaleRecorrenciaState();
}

class _VivaxOvaleRecorrenciaState extends State<VivaxOvaleRecorrencia> {
  @override
  void initState(){
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: rcvdData['tratamento'] == 'Opção 1'? const Text('P.vivax - Recorrência em até 60 dias - Opção 1'): const Text('P.vivax - Recorrência em até 60 dias - Opção 2'), backgroundColor: Colors.cyan,),
        body: SafeArea(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    ):((int.parse(rcvdData['idade'].toString()) > 0 && int.parse(rcvdData['idade'].toString()) < 7)  && rcvdData['tipo_idade'].toString() == 'Anos' || (int.parse(rcvdData['peso'].toString()) > 9 && int.parse(rcvdData['peso'].toString()) < 19)) && int.parse(rcvdData['peso'].toString()) < 121?
                    ListView(  // Idade 1-6 anos && 10-18 Kg
                      children: <Widget>[
                        Container(
                            child:Padding (padding: EdgeInsets.only(top: 10, bottom: 0.0),
                                child: Text.rich(
                    ...
                    ):((int.parse(rcvdData['idade'].toString()) > 6 && int.parse(rcvdData['idade'].toString()) < 12)  && rcvdData['tipo_idade'].toString() == 'Anos' || (int.parse(rcvdData['peso'].toString()) > 18 && int.parse(rcvdData['peso'].toString()) < 30)) && int.parse(rcvdData['peso'].toString()) < 121?
                    ListView(  // Idade 7-11 anos && 19-29 Kg
                      children: <Widget>[
                        Container(
                            child:Padding (padding: EdgeInsets.only(top: 10, bottom: 0.0),
                                child: Text.rich(
                    ...
                    ):((int.parse(rcvdData['idade'].toString()) > 11 && int.parse(rcvdData['idade'].toString()) < 15)  && rcvdData['tipo_idade'].toString() == 'Anos' || (int.parse(rcvdData['peso'].toString()) > 29 && int.parse(rcvdData['peso'].toString()) < 50)) && int.parse(rcvdData['peso'].toString()) < 121?
                    ListView(  // Idade 12-14 anos && 30-49 Kg
                      children: <Widget>[
                        Container(
                            child:Padding (padding: EdgeInsets.only(top: 10, bottom: 0.0),
                                child: Text.rich(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async{
            ...
            Navigator.of(context).pushNamed(AppRoutes.CALENDAR_RECORRENCIA60_VIVAX, arguments: {"tipo": rcvdData['tipo'].toString(), "tratamento": rcvdData['tratamento'].toString()});
