...
class VivaxOvaleGestante extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('P.vivax ou P.ovale - Gestantes'), backgroundColor: Colors.cyan,),
        body: SafeArea(
            ...
            child: Container(
              child: Column(
                children: <Widget>[
                  Container(
                    height: 600,
                    child: (int.parse(rcvdData['idade'].toString()) > 8 && int.parse(rcvdData['idade'].toString()) < 12)  && rcvdData['tipo_idade'].toString() == 'Anos' && (int.parse(rcvdData['peso'].toString()) > 24 && int.parse(rcvdData['peso'].toString()) < 35)?
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            child:Padding (padding: EdgeInsets.only(top: 10, bottom: 0.0),
                                child: Text.rich(
                                  TextSpan(
                                    text:'CLOROQUINA SEMANAL ATÉ UM MÊS DE ALEITAMENTO',
                                    style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 24),
                                  ),
                                )
                            )
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              child: Stack(
                                alignment: Alignment.center,
                                children: <Widget>[
                                  Image.asset('assets/images/CQ-1.png'),
                                  Container(
                                      child: Positioned(
                                          bottom: 30,
                                          child: Text('Cloroquina 150 mg', textAlign: TextAlign.center, style: TextStyle(color: Colors.white))
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              child: Stack(
                                alignment: Alignment.center,
                                children: <Widget>[
                                  Image.asset('assets/images/CQ-2-2.png'),
                                  Container(
                                      child: Positioned(
                                          bottom: 30,
                                          child: Text('Cloroquina 150 mg', textAlign: TextAlign.center, style: TextStyle(color: Colors.white))
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              child: Stack(
                                alignment: Alignment.center,
                                children: <Widget>[
                                  Image.asset('assets/images/CQ-2-3.png'),
                                  Container(
                                      child: Positioned(
                                          bottom: 30,
                                          child: Text('Cloroquina 150 mg', textAlign: TextAlign.center, style: TextStyle(color: Colors.white))
                          ...
                          Padding(
                            ...
                            child: Container(
                                ...
                                child: Stack(
                                  alignment: Alignment.center,
                                  children: <Widget>[
                                    Image.asset('assets/images/CQ-2-4.png'),
                                    Container(
                                        child: Positioned(
                                            bottom: 30,
                                            child: Text('Cloroquina 150 mg', textAlign: TextAlign.center, style: TextStyle(color: Colors.white))
