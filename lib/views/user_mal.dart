                  ...
                  Container(
                    ...
                    child: GestureDetector(
                        onTap: ()async{
                          ...
                          Navigator.of(context).pushNamed(AppRoutes.USER_TRAT, arguments: {"codigo": rcvdData['codigo'].toString(), "data_nascimento": rcvdData['data_nascimento']}).then((value) => print(rcvdData['codigo']));
                          },
                        child: ListTile(
