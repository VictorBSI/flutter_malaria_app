                ...
                children: [
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                        onTap: ()async{
                          await http.post(Uri.parse("http://$fonte/malaria/addMal.php"), body: {
                            "resposta": 'Nunca',
                            "usuario": rcvdData['codigo'].toString(),
                          });
                          Navigator.of(context).pushNamed(AppRoutes.USER_CHAS, arguments: {"codigo": rcvdData['codigo'].toString(), "data_nascimento": rcvdData['data_nascimento']}).then((value) => print(rcvdData['codigo']));
                          },
                        child: ListTile(
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                        onTap: ()async{
                          ...
                          Navigator.of(context).pushNamed(AppRoutes.USER_CHAS, arguments: {"codigo": rcvdData['codigo'].toString(), "data_nascimento": rcvdData['data_nascimento']});
                        },
                        child: ListTile(
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                        onTap: ()async{
                          ...
                          Navigator.of(context).pushNamed(AppRoutes.USER_HOME, arguments: {"codigo": rcvdData['codigo'].toString(), "data_nascimento": rcvdData['data_nascimento']});
                        },
                        child: ListTile(
