                ...
                children: [
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                        ...
                        child: ListTile(
                          title: Text(r'Até 1 salário mínimo (até R$1.100,00)', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
                        )),),
                  Container(
                    margin: const EdgeInsets.all(25),
                    decoration: BoxDecoration(
                    ...
                    child: GestureDetector(
                        ...
                        child: ListTile(
                          title: Text(r'1 a 3 salários mínimos (R$ 1.100,00 a 3.300,00)', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
                        )),),
                  Container(
                    margin: const EdgeInsets.all(25),
                    decoration: BoxDecoration(
                    ...
                    child: GestureDetector(
                        ...
                        child: ListTile(
                          title: Text(r'3 a 6 salários mínimos (R$ 3.300,00 a 6.600,00)', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
                        )),),
                  Container(
                    margin: const EdgeInsets.all(25),
                    decoration: BoxDecoration(
                    ...
                    child: GestureDetector(
                        ...
                        child: ListTile(
                          title: Text(r'Mais de 6 salários mínimos (mais de 6.600,00)', textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
                        )),),
                ],
              ),
            )
